 ...
 */
public class DeathInjuryEquipment {
	...
	private String modelYear; // Maps to ProdYear on the XML/XSL - column name on table is model_yr, thus I
								// used this variable name
	...
	public String toString() {
		return "DeathInjuryEquipment [seqId=" + seqId + ", ewrId=" + ewrId + ", ewrReportId=" + ewrReportId
				+ ", manUniqueId=" + manUniqueId + ", make=" + make + ", model=" + model + ", modelYear=" + modelYear
				+ ", productIdentifier=" + productIdentifier + ", incidentDate=" + incidentDate + ", numDeaths="
				+ numDeaths + ", numInjuries=" + numInjuries + ", stateOrFCntry=" + stateOrFCntry + ", sysOrCompA="
				+ sysOrCompA + ", sysOrCompB=" + sysOrCompB + ", sysOrCompC=" + sysOrCompC + ", sysOrCompD="
				+ sysOrCompD + ", sysOrCompE=" + sysOrCompE + ", fileName=" + fileName + "]";
	}
