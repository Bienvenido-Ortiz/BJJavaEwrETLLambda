...
public class EwrUtils {
	...
	public static ReportInfo mapReportInfoAggregateXMLData(InputStream file, String filename) {
		EwrLogs.DEBUG("EwrUtils", "mapReportInfoAggregateXMLData", "Entering Method");
		...
		try {
			...
			EwrLogs.ERROR("EwrUtils", "mapReportInfoAggregateXMLData", e.getMessage());
			return null;
		}
	}
	...
	public static ReportInfo mapReportInfoAggregateXMLDataForTires(InputStream file, String filename) {
		EwrLogs.DEBUG("EwrUtils", "mapReportInfoAggregateXMLDataForTires", "Entering Method");
		SAXBuilder saxBuilder = new SAXBuilder();
		org.jdom2.Document jdomDoc;
		try {
			jdomDoc = saxBuilder.build(file);
			...
			EwrLogs.ERROR("EwrUtils", "mapReportInfoAggregateXMLDataForTires", "EXCEPTION: " + e.getMessage());
			return null;
		}
	}	
	...
	public static ReportInfo mapReportInfoSimilarVehiclesXMLData(InputStream file, String filename) {
		EwrLogs.DEBUG("EwrUtils", "mapReportInfoSimilarVehiclesXMLData", "Entering Method");
	...
	//				substantiallySimilarVehicleRecord.setForeignProductId(counter); THIS WOULD BE SET AT THE RDSUtils CLASS WHILE PERSISTING
			...
			EwrLogs.ERROR("EwrUtils", "mapReportInfoSimilarVehiclesXMLData", "EXCEPTION: " + e.getMessage());
			return null;
		}
	}
	...
	public static ReportInfo mapReportInfoDeathAndInjuryXMLDataForEquipments(InputStream file, String filename) {
		EwrLogs.DEBUG("EwrUtils", "mapReportInfoDeathAndInjuryXMLDataForEquipments", "Entering Method");
		SAXBuilder saxBuilder = new SAXBuilder();
		org.jdom2.Document jdomDoc;
		try {
			jdomDoc = saxBuilder.build(file);
			...
			if(diEquipmentListElements != null) {
				for (Element diElement : diEquipmentListElements) {
					...
					String compDefaultVal = ""; //String compDefaultVal = "00";
			...
			EwrLogs.ERROR("EwrUtils", "mapReportInfoDeathAndInjuryXMLDataForEquipments", "EXCEPTION: " + e.getMessage());
			return null;
		}
	}
	...
	public static ReportInfo mapReportInfoDeathAndInjuryXMLDataForTires(InputStream file, String filename) {
		EwrLogs.DEBUG("EwrUtils", "mapReportInfoDeathAndInjuryXMLDataForTires", "Entering Method");
		SAXBuilder saxBuilder = new SAXBuilder();
		org.jdom2.Document jdomDoc;
		try {
			jdomDoc = saxBuilder.build(file);
			...
			EwrLogs.ERROR("EwrUtils", "mapReportInfoDeathAndInjuryXMLDataForTires", "EXCEPTION: " + e.getMessage());
			return null;
		}
	}
	...
	public static ReportInfo mapReportInfoDeathAndInjuryXMLData(InputStream file, String filename) {
		EwrLogs.DEBUG("EwrUtils", "mapReportInfoDeathAndInjuryXMLData", "Entering Method");
		SAXBuilder saxBuilder = new SAXBuilder();
		org.jdom2.Document jdomDoc;
		try {
			jdomDoc = saxBuilder.build(file);
			...
			EwrLogs.DEBUG("EwrUtils", "mapReportInfoDeathAndInjuryXMLData", "EXCEPTION " + e.getMessage());
			return null;
		}
	}
	...
	public static List<AggregateTireProduction> getAggregateProductionFromXMLForTires(ReportInfo reportInfo, String reportName, List<Element> productionElements) {
		...
		for (Element prodElement : productionElements) {
			...
			aggrProdRecord.setSku(prodElement.getChildText("SKU"));
	...
	public static List<AggregateData> getAggregateDataFromXML(ReportInfo reportInfo, String aggregateTypeCode, String reportCategory, List<Element> aggregateDataElements ){
		...
		for (Element anAggregateDataElement : aggregateDataElements) {
			...
			aggregateRecord.setTypeCode(anAggregateDataElement.getChildText("Type"));
